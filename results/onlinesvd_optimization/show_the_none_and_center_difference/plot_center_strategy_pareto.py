#!/usr/bin/env python3
"""Plot Pareto frontier comparing center_none vs center_fp32 runs."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--results-dir",
        type=Path,
        default=Path("show_the_none_and_center_difference"),
        help=(
            "Directory containing subfolders like center_none_fp16 "
            "and center_fp32_fp16."
        ),
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path(
            "show_the_none_and_center_difference/pareto_center_none_vs_center_fp32.png"
        ),
    ...
    parser.add_argument(
        "--modes",
        nargs="+",
        default=["center_none", "center_fp32"],
